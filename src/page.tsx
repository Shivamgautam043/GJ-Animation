...
export function Page(ele:data) {
  ...
  return (
    <>
      <div className="tw-relative tw-h-[100vh] ">
        <div className=" tw-sticky tw-bg-[url('/bg.png')] tw-bg-center tw-flex tw-justify-center tw-overflow-hidden">
          {obj.map((item, index) => (
            <Floater
              key={index}
              xIn={item.xIn}
          ...
          <div className="main tw-w-[100%] tw-h-[100vh] tw-bg-[url('/bg.png')]  tw-bg-center tw-flex tw-flex-col tw-items-center tw-justify-center">
            <motion.div
            ...
            >
              ...
              <div className="tw-text-xl tw-text-center tw-py-[20px]">unlock access to 100+ realms</div>
